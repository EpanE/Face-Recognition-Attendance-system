...
people = ['Epan', 'Ikram', 'Fatah Amin']  # Add more names if your model is trained for multiple people
...
cap = cv.VideoCapture(1)  # 0 for default camera, change if using a different camera
