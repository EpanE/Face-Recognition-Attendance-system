...
people = ['MUHAMAD IRFAN', '']  # Add more names if your model is trained for multiple people

# Create and load the face recognizer
face_recognizer = cv.face.LBPHFaceRecognizer_create()
face_recognizer.read('Epan_facetrained.yml')
...
threshold = 70  # Adjust this value based on your requirements
...
while True:
    ...
    for (x, y, w, h) in faces_rect:
        ...
        cv.rectangle(frame, (x, y), (x+w, y+h), (0, 255, 0), 2) # Colour of the rectangle
